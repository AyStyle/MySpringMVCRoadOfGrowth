...
<body>
    <div>
        ...
        <fieldset>
            ...
            <a href="/demo/handle04?name=ankang&age=18">点击测试</a>
        </fieldset>

        <fieldset>
            <p>测试用例：SpringMVC接收pojo包装类型参数</p>
            <a href="/demo/handle05?innerUser.age=18&innerUser.name=ankang">点击测试</a>
        </fieldset>

        <fieldset>
            <p>测试用例：SpringMVC接收日期类型参数</p>
            <a href="/demo/handle06?birthday=2020-10-01">点击测试</a>
        </fieldset>
    </div>
